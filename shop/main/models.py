...
class Basket(models.Model):
    ...
    def total_price(self):
        basket_items = self.basket_items.all()
...
class BasketItem(models.Model):
    product = models.ForeignKey(Sneakers, on_delete=models.CASCADE, related_name='items')
    ...
    @property
    def price(self):
        new_price = self.product.price * self.quantity + 99
        return new_price
